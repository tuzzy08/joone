...
2.  **Next delivery slice:** inspect the new hosted run after the explicit publish/artifact changes and confirm the GitHub release plus workflow artifacts now contain all three platform bundles, then continue with any remaining release polish or manual packaged-app smoke testing.
