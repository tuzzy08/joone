...
2.  **Next delivery slice:** continue packaging/release finish work on top of the validated cross-platform bundle workflow, with the main remaining work now being final release-artifact polish and any extra hardening that falls out of the new CI smoke checks.
